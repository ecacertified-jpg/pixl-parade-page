...
Le bucket public 'assets' héberge tous les médias statiques : images (ex: 'birthday-countdown.jpeg', 'birthday-friend-alert.jpg') et vidéos d'anniversaire (ex: 'default-celebration.mp4'). L'accès en lecture est public pour permettre la récupération par les serveurs de Meta et l'affichage dans l'app.
