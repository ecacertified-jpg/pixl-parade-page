      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-1">
          <Button
            ...
            className={cn(
              "flex-1 h-9 text-xs gap-2 hover:bg-red-50 hover:text-red-600 transition-colors",
              userReaction === 'love' && "bg-red-50 text-red-600"
            )}
          >
            <Heart className={cn("h-4 w-4", userReaction === 'love' && "fill-current")} />
            J'adore
          </Button>
          ...
          <Button
            ...
            className={cn(
              "flex-1 h-9 text-xs gap-2 hover:bg-primary/10 hover:text-primary transition-colors",
              userReaction === 'gift' && "bg-primary/10 text-primary"
            )}
          >
            <Gift className={cn("h-4 w-4", userReaction === 'gift' && "fill-current")} />
            Cadeau
          </Button>
          ...
          <Button
            ...
            className={cn(
              "flex-1 h-9 text-xs gap-2 hover:bg-blue-50 hover:text-blue-600 transition-colors",
          ...
          <Button
            ...
            className="flex-1 h-9 text-xs gap-2 hover:bg-muted/50 transition-colors"
          >
