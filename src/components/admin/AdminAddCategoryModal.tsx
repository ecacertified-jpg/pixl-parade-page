...
import { BusinessCategory, CategoryInput } from '@/hooks/useAdminBusinessCategories';

interface AdminAddCategoryModalProps {
  open: boolean;
  onClose: () => void;
  onSave: (category: CategoryInput) => Promise<any>;
...
export function AdminAddCategoryModal({ open, onClose, onSave, category, businessName }: AdminAddCategoryModalProps) {
