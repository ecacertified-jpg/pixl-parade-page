    ...
    <Card className="bg-card/80 backdrop-blur-sm border border-border/50 shadow-card p-6 rounded-2xl">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <Button
          ...
          variant="outline"
          className="h-auto py-4 px-4 flex items-center justify-center gap-3 bg-card hover:bg-muted/50 border border-border rounded-2xl transition-all duration-200 hover:shadow-md"
        >
