...
function OccasionCard({ title, subtitle, icon, bgColor, iconBg }: OccasionCardProps) {
  return (
    <Card className={`p-4 text-center hover:shadow-soft transition-all duration-200 hover:scale-105 cursor-pointer ${bgColor}`}>
