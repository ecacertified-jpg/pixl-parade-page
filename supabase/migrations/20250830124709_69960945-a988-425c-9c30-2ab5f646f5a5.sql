-- Nettoyer et recréer les triggers pour fund_contributions
-- Supprimer tous les triggers existants sur fund_contributions
...
-- 1. D'abord mettre à jour le montant actuel du fonds
