-- Create business collective funds extension (fixed)
...
-- Create function to find users in business delivery zones (fixed syntax)
...
-- Create function to create business collective fund (fixed syntax)
CREATE OR REPLACE FUNCTION public.create_business_collective_fund(
  ...
  p_target_amount NUMERIC DEFAULT 10000,
