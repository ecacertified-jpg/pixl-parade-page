...
-- performance_metrics: tighten INSERT policy
DROP POLICY IF EXISTS "System can insert performance metrics" ON public.performance_metrics;

CREATE POLICY IF NOT EXISTS "Users can insert their performance metrics"
...
CREATE POLICY IF NOT EXISTS "Admins can view secure fund activities"
...
-- Helper: safely set search_path to public where functions exist
